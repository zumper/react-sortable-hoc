    ...
    return (
      (n = e = (function(e) {
        function n(e) {
          ...
          return (
            u(this, n),
            (k = y(this, g(n).call(this, e))),
            c(p(p(k)), 'state', {}),
            c(p(p(k)), 'handleStart', function(e) {
              var t = k.props,
                n = t.distance,
                o = t.shouldCancelStart;
              if (2 !== e.button && !o(e)) {
                (k.touched = !0), (k.position = K(e));
                var r,
                ...
                if (
                  ...
                  var a = k.props.useDragHandle,
                    s = i.sortableInfo,
                    l = s.index,
                    c = s.collection;
                  if (s.disabled) return;
                  if (a && !W(e.target, J)) return;
                  (k.manager.active = {collection: c, index: l}),
                    ((r = e).touches && r.touches.length) ||
                      (r.changedTouches && r.changedTouches.length) ||
                      e.target.tagName !== z.Anchor ||
                      e.preventDefault(),
                    n ||
                      (0 === k.props.pressDelay
                        ? k.handlePress(e)
                        : (k.pressTimer = setTimeout(function() {
                            return k.handlePress(e);
                          }, k.props.pressDelay)));
                }
              }
            }),
            c(p(p(k)), 'nodeIsChild', function(e) {
              return e.sortableInfo.manager === k.manager;
            }),
            c(p(p(k)), 'handleMove', function(e) {
              var t = k.props,
                n = t.distance,
                o = t.pressThreshold;
              if (
                !k.state.sorting &&
                k.touched &&
                !k._awaitingUpdateBeforeSortStart
              ) {
                var r = K(e),
                  i = {x: k.position.x - r.x, y: k.position.y - r.y},
                  a = Math.abs(i.x) + Math.abs(i.y);
                (k.delta = i),
                  n || (o && !(o <= a))
                    ? n && n <= a && k.manager.isActive() && k.handlePress(e)
                    : (clearTimeout(k.cancelTimer),
                      (k.cancelTimer = setTimeout(k.cancel, 0)));
              }
            }),
            c(p(p(k)), 'handleEnd', function() {
              (k.touched = !1), k.cancel();
            }),
            c(p(p(k)), 'cancel', function() {
              var e = k.props.distance;
              k.state.sorting ||
                (e || clearTimeout(k.pressTimer), (k.manager.active = null));
            }),
            c(p(p(k)), 'handlePress', function(C) {
              try {
                var r = k.manager.getActive(),
                  e = (function() {
                    if (r) {
                      var e = function() {
                          var e,
                            ...
                            l = k.scrollContainer.getBoundingClientRect(),
                            c = v({collection: O, index: a, node: S});
                          if (
                            ((k.node = S),
                            (k.margin = s),
                            (k.width = c.width),
                            (k.height = c.height),
                            (k.marginOffset = {
                              x: k.margin.left + k.margin.right,
                              y: Math.max(k.margin.top, k.margin.bottom),
                            }),
                            (k.boundingClientRect = S.getBoundingClientRect()),
                            (k.containerBoundingRect = l),
                            (k.index = a),
                            (k.newIndex = a),
                            (k.axis = {
                              x: 0 <= g.indexOf('x'),
                            ...
                            (k.offsetEdge = _(S, k.container)),
                            (k.initialOffset = K(
                              T
                                ? I({}, C, {
                                    pageX: k.boundingClientRect.left,
                                    pageY: k.boundingClientRect.top,
                                  })
                                : C,
                            )),
                            (k.initialScroll = {
                              left: k.scrollContainer.scrollLeft,
                              top: k.scrollContainer.scrollTop,
                            }),
                            (k.initialWindowScroll = {
                              left: window.pageXOffset,
                              top: window.pageYOffset,
                            }),
                            (k.helper = k.helperContainer.appendChild(
                              ((o =
                                'input, textarea, select, canvas, [contenteditable]'),
                              (r = (n = S).querySelectorAll(o)),
                              (i = n.cloneNode(!0)),
                              E(i.querySelectorAll(o)).forEach(function(e, t) {
                            ...
                            N(k.helper, {
                              ...
                              left: ''.concat(
                                k.boundingClientRect.left - s.left,
                                'px',
                              ),
                              pointerEvents: 'none',
                              position: 'fixed',
                              top: ''.concat(
                                k.boundingClientRect.top - s.top,
                                'px',
                              ),
                              width: ''.concat(k.width, 'px'),
                            }),
                            T && k.helper.focus(),
                            x &&
                              N((k.sortableGhost = S), {
                            ...
                            var u = w
                                ? {
                                    top: 0,
                                    left: 0,
                                    width: k.contentWindow.innerWidth,
                                    height: k.contentWindow.innerHeight,
                                  }
                                : k.containerBoundingRect,
                              d = u.top,
                              f = u.left,
                              h = u.width,
                              p = d + u.height,
                            ...
                            k.axis.x &&
                              ((k.minTranslate.x =
                                f - k.boundingClientRect.left),
                              (k.maxTranslate.x =
                                y - (k.boundingClientRect.left + k.width))),
                              k.axis.y &&
                                ((k.minTranslate.y =
                                  d - k.boundingClientRect.top),
                                (k.maxTranslate.y =
                                  p - (k.boundingClientRect.top + k.height)));
                          } else
                            k.axis.x &&
                              ((k.minTranslate.x =
                                (w ? 0 : l.left) -
                                k.boundingClientRect.left -
                                k.width / 2),
                              (k.maxTranslate.x =
                                (w
                                  ? k.contentWindow.innerWidth
                                  : l.left + l.width) -
                                k.boundingClientRect.left -
                                k.width / 2)),
                              k.axis.y &&
                                ((k.minTranslate.y =
                                  (w ? 0 : l.top) -
                                  k.boundingClientRect.top -
                                  k.height / 2),
                                (k.maxTranslate.y =
                                  (w
                                    ? k.contentWindow.innerHeight
                                    : l.top + l.height) -
                                  k.boundingClientRect.top -
                                  k.height / 2));
                          m &&
                            m.split(' ').forEach(function(e) {
                              return k.helper.classList.add(e);
                            }),
                            (k.listenerNode = C.touches
                              ? C.target
                              : k.contentWindow),
                            T
                              ? (k.listenerNode.addEventListener(
                                  'wheel',
                                  k.handleKeyEnd,
                                  !0,
                                ),
                              ...
                              : (R.move.forEach(function(e) {
                                  return k.listenerNode.addEventListener(
                                    e,
                                    k.handleSortMove,
                                    !1,
                                  );
                            ...
                            k.setState({sorting: !0, sortingIndex: a}),
                            b &&
                              b(
                                {
                                  node: S,
                        ...
                        t = k.props,
                        g = t.axis,
                        v = t.getHelperDimensions,
                        m = t.helperClass,
                        x = t.hideSortableGhost,
                        n = t.updateBeforeSortStart,
                        b = t.onSortStart,
                        w = t.useWindowAsScrollContainer,
                        S = r.node,
                        O = r.collection,
                        T = k.manager.isKeySorting,
                        o = (function() {
                          if ('function' == typeof n) {
                            k._awaitingUpdateBeforeSortStart = !0;
                            var e = (function(e, t) {
                              try {
                                var n = e();
                              } catch (e) {
                              ...
                              function(e, t) {
                                if (
                                  ((k._awaitingUpdateBeforeSortStart = !1), e)
                                )
                                  throw t;
                                return t;
                              },
            ...
            c(p(p(k)), 'handleSortMove', function(e) {
              var t = k.props.onSortMove;
              'function' == typeof e.preventDefault && e.preventDefault(),
                k.updateHelperPosition(e),
                k.animateNodes(),
                k.autoscroll(),
                t && t(e);
            }),
            c(p(p(k)), 'handleSortEnd', function(e) {
              var t = k.props,
              ...
              k.listenerNode &&
                (a
                  ? (k.listenerNode.removeEventListener(
                      'wheel',
                      k.handleKeyEnd,
                      !0,
                    ),
                  ...
                  : (R.move.forEach(function(e) {
                      return k.listenerNode.removeEventListener(
                        e,
                        k.handleSortMove,
                      );
                    }),
                ...
                k.helper.parentNode.removeChild(k.helper),
                n &&
                  k.sortableGhost &&
                  N(k.sortableGhost, {opacity: '', visibility: ''});
              ...
              k.autoScroller.clear(),
                (k.manager.active = null),
                (k.manager.isKeySorting = !1),
                k.setState({sorting: !1, sortingIndex: null}),
                'function' == typeof o &&
                  o(
                    {
                      collection: i,
            ...
            c(p(p(k)), 'autoscroll', function() {
              var e = k.props.disableAutoscroll,
                t = k.manager.isKeySorting;
              if (e) k.autoScroller.clear();
              else {
                if (t) {
                  var n = I({}, k.translate),
                    o = 0,
                  ...
                  return (
                    k.axis.x &&
                      ((n.x = Math.min(
                        k.maxTranslate.x,
                        Math.max(k.minTranslate.x, k.translate.x),
                      )),
                      (o = k.translate.x - n.x)),
                    k.axis.y &&
                      ((n.y = Math.min(
                        k.maxTranslate.y,
                        Math.max(k.minTranslate.y, k.translate.y),
                      )),
                      (r = k.translate.y - n.y)),
                    (k.translate = n),
                    A(k.helper, k.translate),
                    (k.scrollContainer.scrollLeft += o),
                    void (k.scrollContainer.scrollTop += r)
                  );
                }
                k.autoScroller.update({
                  height: k.height,
                  maxTranslate: k.maxTranslate,
            ...
            c(p(p(k)), 'onAutoScroll', function(e) {
              (k.translate.x += e.left),
                (k.translate.y += e.top),
                k.animateNodes();
            }),
            c(p(p(k)), 'handleKeyDown', function(e) {
              var t = e.keyCode,
                n = k.props,
                o = n.shouldCancelStart,
                r = n.keyCodes,
                i = I({}, ee, void 0 === r ? {} : r);
              (k.manager.active && !k.manager.isKeySorting) ||
                !(
                  k.manager.active ||
                  (i.lift.includes(t) && !o(e) && k.isValidSortingTarget(e))
                ) ||
                (e.stopPropagation(),
                e.preventDefault(),
                i.lift.includes(t) && !k.manager.active
                  ? k.keyLift(e)
                  : i.drop.includes(t) && k.manager.active
                  ? k.keyDrop(e)
                  : i.cancel.includes(t)
                  ? ((k.newIndex = k.manager.active.index), k.keyDrop(e))
                  : i.up.includes(t)
                  ? k.keyMove(-1)
                  : i.down.includes(t) && k.keyMove(1));
            }),
            c(p(p(k)), 'keyLift', function(e) {
              var t = e.target,
                n = W(t, function(e) {
                  return null != e.sortableInfo;
                }).sortableInfo,
                o = n.index,
                r = n.collection;
              (k.initialFocusedNode = t),
                (k.manager.isKeySorting = !0),
                (k.manager.active = {index: o, collection: r}),
                k.handlePress(e);
            }),
            c(p(p(k)), 'keyMove', function(e) {
              var t = k.manager.getOrderedRefs(),
                n = t[t.length - 1].node.sortableInfo.index,
                o = k.newIndex + e,
                r = k.newIndex;
              if (!(o < 0 || n < o)) {
                (k.prevIndex = r), (k.newIndex = o);
                var i,
                  a,
                  s,
                  l =
                  ...
                  u = c.node,
                  d = k.containerScrollDelta,
                  f = c.boundingClientRect || H(u, d),
                  h = c.translate || {x: 0, y: 0},
                  p = f.top + h.y - d.top,
                  y = f.left + h.x - d.left,
                  g = r < o,
                  v = g && k.axis.x ? u.offsetWidth - k.width : 0,
                  m = g && k.axis.y ? u.offsetHeight - k.height : 0;
                k.handleSortMove({
                  pageX: y + v,
                  pageY: p + m,
            ...
            c(p(p(k)), 'keyDrop', function(e) {
              k.handleSortEnd(e),
                k.initialFocusedNode && k.initialFocusedNode.focus();
            }),
            c(p(p(k)), 'handleKeyEnd', function(e) {
              k.manager.active && k.keyDrop(e);
            }),
            c(p(p(k)), 'isValidSortingTarget', function(e) {
              var t = k.props.useDragHandle,
                n = e.target,
                o = W(n, function(e) {
                  return null != e.sortableInfo;
                });
